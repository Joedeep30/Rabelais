    ...
    <html lang="fr" suppressHydrationWarning>
      ...
      >
        ...
        <div className="fixed right-0 top-1/2 -translate-y-1/2 z-[9000] w-[94px]">
          <Link prefetch={true} href="/#home-page-contact" className="bg-[#2b3787] text-white py-[21px] px-[5px] flex flex-col items-center justify-center text-center shadow-lg hover:bg-blue-800 transition-colors">
