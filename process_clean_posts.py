...
mapping = {
    "post6_map_clean": "post6-plan-acces-lyon.jpg",
    "post7_ord_clean": "post7-consultation-ordonnance.jpg",
    "post8_urg_clean": "post8-delais-urgence-retine.jpg",
}
...
print("Done processing completely clean photorealistic Post illustrations.")
